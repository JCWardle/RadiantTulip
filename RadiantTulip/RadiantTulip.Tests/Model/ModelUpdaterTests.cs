...
namespace RadiantTulip.Tests.Model
{
    ...
    public class ModelUpdaterTests
    {
        ...
        [Test]
        public void Player_Without_Position_Is_Made_Invisible()
        {
            var game = new Game() { Teams = new List<Team>() };
            var player = new Player
            {
                ...
                Positions = new List<Position> 
                {
                    new Position { X = 2, Y = 2, TimeStamp = new TimeSpan(0, 0, 0, 0, 00) },
                    new Position { X = 2, Y = 2, TimeStamp = new TimeSpan(0, 0, 0, 0, 10) },
                    new Position { X = 2, Y = 2, TimeStamp = new TimeSpan(0, 0, 0, 0, 40) }
                }
            };
            var team = new Team()
            {
        ...
        [Test]
        public void Player_With_New_Position_Is_Visible()
        {
            var game = new Game() { Teams = new List<Team>() };
            var player = new Player
            {
